...
static const uint8_t *USBD_Composite_GetHSCfgDesc (uint16_t *length);

//static uint8_t *USBD_Composite_GetOtherSpeedCfgDesc (uint16_t *length);

static const uint8_t *USBD_Composite_GetOtherSpeedCfgDesc (uint16_t *length);
...
USBD_ClassTypeDef USBD_Composite = 
{
  ...
  NULL, //TODO
  NULL, //TODO
  //I know what i'am doing (to avoid gcc warnings)
  (void *)USBD_Composite_GetHSCfgDesc,
  (void *)USBD_Composite_GetFSCfgDesc,
  (void *)USBD_Composite_GetOtherSpeedCfgDesc,
  (void *)USBD_Composite_GetDeviceQualifierDescriptor,
};
...
void USBD_Composite_Set_Descriptor(const uint8_t *descriptor, uint16_t size) {
    config_descriptor = (uint8_t*)descriptor;
